...
variables = {
    ...
    "cov_ever_hypertension": [hypertension_icd10, hypertension_drugs_dmd, hypertension_snomed],
    "cov_ever_diabetes": [diabetes_snomed, diabetes_icd10, diabetes_drugs_dmd],
