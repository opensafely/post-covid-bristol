...
# np.min([max_expo_date, max_record_date, max_DATE_OF_DEATH]) from DB
cohort_end_date <- as.Date("2021-04-19") #limiting dataset == death -- 26.04.2021 - 1wk
# 
# ggplot(cohort_vac, aes(x=DATE_OF_DEATH)) + 
#   geom_histogram(binwidth=1)+
#   labs(title="Cumulative proportion vaccinated over time",x="Date of vaccination", y="cumulative proportion vaccinated")+
