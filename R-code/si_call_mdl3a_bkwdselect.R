...
## Author: Samantha Ip
## ==============================================================================
source(file.path(scripts_dir,"si_fit_model_fullcovariates_bkwdselection.R"))
...
get_vacc_res <- function(event, vac_str, agegp, cohort_vac, agebreaks, agelabels, covars, cuts_weeks_since_expo, master_df_fpath, cohort_start_date, cohort_end_date, noncase_frac=0.1){
  ...
  res_vacc <- fit_model_fullcovariates(covars, vac_str, agebreaks, agelabels, agegp, event, survival_data, cuts_weeks_since_expo, cohort_start_date, cohort_end_date, expo="VACCINE", noncase_frac=0.1)
